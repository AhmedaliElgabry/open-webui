			...
			<div class="flex flex-col max-w-6xl px-2.5 md:px-6 w-full">
				...
				<div class="w-full relative">
					...
					{#if atSelectedModel !== undefined}
						<div
							class="px-1 py-1 text-left w-full flex justify-between items-center absolute bottom-0 left-0 right-0 bg-gradient-to-t from-50% from-white dark:from-gray-900 opacity-8"
						>
